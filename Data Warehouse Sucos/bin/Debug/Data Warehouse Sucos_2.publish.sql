...
GO
PRINT N'Rename refactoring operation with key 52d5d776-0412-4e6f-9b23-2d7cd3baf51f is skipped, element [dbo].[Dim_Categoria].[Id] (SqlSimpleColumn) will not be renamed to Cod_Categoria';


GO
PRINT N'Rename refactoring operation with key 7e7d05ab-1eab-4961-974b-967cee86381e is skipped, element [dbo].[Dim_Marca].[Id] (SqlSimpleColumn) will not be renamed to Cod_Marca';


GO
PRINT N'Rename refactoring operation with key 0b60fdf5-b6ab-4998-929e-9fcc55ae42eb, 259ca337-6a42-42f4-9c6f-86f2f5c16539 is skipped, element [dbo].[FK_Dim_Marca_ToTable] (SqlForeignKeyConstraint) will not be renamed to [FK_Dim_Marca_Dim_Categoria]';


GO
PRINT N'Rename refactoring operation with key 24e60663-8029-41bf-90a6-8ce07f77a49f is skipped, element [dbo].[Dim_Produto].[Id] (SqlSimpleColumn) will not be renamed to Cod_Produto';
