...
GO
PRINT N'Rename refactoring operation with key 6d5a65c8-368e-4100-8441-cfc305a25358 is skipped, element [dbo].[Dim_Tempo].[Id] (SqlSimpleColumn) will not be renamed to Cod_Dia';


GO
PRINT N'Rename refactoring operation with key 99677dbf-8fe8-44ee-97f7-0d1c96208609 is skipped, element [dbo].[Dim_Tempo].[Date] (SqlSimpleColumn) will not be renamed to Data';


GO
PRINT N'Rename refactoring operation with key 7eec9a13-83a4-4dbc-b0ca-b74572ae4ee7 is skipped, element [dbo].[Dim_Tempo].[E_Dia_Semana] (SqlSimpleColumn) will not be renamed to Tipo_Dia';
